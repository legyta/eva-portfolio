  ...
  return (
    <div className="work">
      ...
      <div className="work-info">
        ...
        <p>
          Our appointments are weekly at the same time each week, at the time we
          agree together.
        </p>

        <p>
          The appointments last 50 minutes, these appointments are confidential,
          which means that what you share with me stays in the room, or is a
          private zoom call.{" "}
        </p>
        ...
        <p>
          ...
          in to the work. This can take the form of a more physical expression
          of emotions, or we may work with letter writing and inner
          vulnerability work.
        </p>
        ...
        <p>
          I also work in Schools as a child and adolescent therapist, so I bring
          creativity, art and play into the way I work.
        </p>

        <p>
          Sometimes when we start feeling things for the first time, therapy can
          feel more painful before we feel more free and able to cope.
        </p>
        ...
        <p>
          ...
          seeing a therapist can remind us of emotions we don’t want to feel in
          that moment.
        </p>

        <p>
          For this reason my policy is that if I see you when we are both
          outside the centre, I wont say hello or come over unless you say hello
          to me.
        </p>

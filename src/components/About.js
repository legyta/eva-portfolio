  ...
  return (
    <div className="about">
      ...
      <div className="about-info">
        ...
        <p>
          Born and raised in Devon to psychotherapist parents, I followed in
          their footsteps and started training from a young age towards my
          passion, which is the never ending journey of discovering/
          understanding what it is to be human for me and others, it has meant I
          have an innate joy and curiosity for the ever evolving expression of
          the diverse experience of being on this earth together.
        </p>
        ...
        <p>
          ...
          realization at the importance of giving more time, and sessions to
        ...
        <p>
          ...
          (emotional freedom technique) the concept of self-love which can
          completely transform someone&#39;s self-perception. I am a believer in
          re-programming how we think, and I believe compassion is the most
          effective tool.
        </p>
